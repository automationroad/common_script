...
#读取需要删除的编号
cat /mnt/d/Workspace/需要删除的编号.xml | awk '{print $1}' | sort -d | uniq | sed -i s/^0/_0/g /mnt/d/Workspace/需要删除的编号.xml
#cat /mnt/d/Workspace/需要删除的编号.xml | awk '{print $1}' | sort -d | uniq | sed -i s/$/&_/g /mnt/d/Workspace/需要删除的编号.xml
projectname=`cat /mnt/d/Workspace/需要删除的编号.xml | awk '{print $1}' | sort -d | uniq`
#echo ${projectname}
...
sed -i s/^_0/0/g /mnt/d/Workspace/接口备注.xml
