...
#上传到65的120文件夹
ls ${path} | egrep -v bxkcA1.iwa | egrep -v ^[0-9]\{1,2\}.iwa | grep -v 'war' | xargs -I {} scp ${path}{} root@192.168.2.65:/packs/120/
#更新65上的iwa项目
...
#上传到120的iwa
ls ${path} | egrep -v bxkcA1.iwa | egrep -v ^[0-9]\{1,2\}.iwa | grep -v 'war' | xargs -I {} scp -P 12022 ${path}{} appuser@121.46.18.113:/packs/projects/
